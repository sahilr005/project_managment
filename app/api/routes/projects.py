...
@router.post("", response_model=ProjectOut,dependencies=[Depends(require_role("owner","admin","manager"))])
...
@router.patch("/{project_id}", response_model=ProjectOut,dependencies=[Depends(require_role("owner","admin","manager"))])
...
@router.delete("/{project_id}", status_code=204,dependencies=[Depends(require_role("owner","admin"))])
